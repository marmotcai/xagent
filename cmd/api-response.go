...
func generateListBucketsResponse(buckets []BucketInfo) ListBucketsResponse {
	...
	owner.ID = globalXAgentDefaultOwnerID
...
func generateListPartsResponse(partsInfo ListPartsInfo, encodingType string) ListPartsResponse {
	...
	listPartsResponse.StorageClass = globalXAgentDefaultStorageClass
	listPartsResponse.Initiator.ID = globalXAgentDefaultOwnerID
	listPartsResponse.Owner.ID = globalXAgentDefaultOwnerID
...
func writeErrorResponse(ctx context.Context, w http.ResponseWriter, err APIError, reqURL *url.URL, browser bool) {
	switch err.Code {
	case "SlowDown", "XXAgentServerNotInitialized", "XXAgentReadQuorum", "XXAgentWriteQuorum":
